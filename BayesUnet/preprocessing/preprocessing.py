...
from preprocessing.main import RESAMPLING_SEPARATE_Z_ANISO_THRESHOLD
from preprocessing.crop import get_case_identifier_from_npz, ImageCropper
...
class GenericPreprocessor(object):
    ...
    def _run_internal(self, target_spacing, case_identifier, output_folder_stage, cropped_output_dir, force_separate_z,
        ...
        data, seg, properties = self.resample_and_normalize(data, target_spacing,
                                                            properties, seg, force_separate_z) # wywołuje w końcu printy od "seperate z" do "after: ....."
        ...
        for c in all_classes:
            ...
            print("c, target_num_samples:", c, target_num_samples) # to te dziwne numerki, dopisek do printa później dodany mój
        properties['class_locations'] = class_locs

        print("saving: ", os.path.join(output_folder_stage, "%s.npz" % case_identifier)) # paradoksalnie to jest koniec przetwarzania :/
